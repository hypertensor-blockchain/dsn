...
# def get_online_peers_data_await(dht: hivemind.DHT) -> List:
#     ready = Future()
#     async def get_p2p():
#         try:
#             bootstrap_peer_ids = []
...
#                 # peer_id = hivemind.PeerID.to_bytes(info.peer_id)

#                 # peer_id = hivemind.PeerID.from_base58(Multiaddr(info.peer_id)["p2p"])
#                 if info.peer_id not in bootstrap_peer_ids:
#                     bootstrap_peer_ids.append(info.peer_id)
