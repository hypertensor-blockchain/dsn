...
from petals.models.llama.block import WrappedLlamaBlock, WrappedLlamaBlockValidator
...
class DistributedLlamaConfigValidator(LlamaConfig, ClientConfigValidator, PTuneConfigValidator, LMHeadConfigValidator):
