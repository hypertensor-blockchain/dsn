...
from subnet.models.bloom.config import DistributedBloomConfigValidator
...
class DistributedBloomModelValidator(FromPretrainedMixinValidator, PTuneMixinValidator, BloomModel):
    """BloomModel, but all transformer layers are hosted by the swarm"""
    ...
    def __init__(
        ...
        *, 
        ...
        self.h = RemoteSequentialValidator(config, dht=dht, identity_path=identity_path)
...
class DistributedBloomForCausalLMValidator(FromPretrainedMixinValidator, RemoteGenerationMixinValidator, BloomForCausalLM):
    ...
    def __init__(self, config: DistributedBloomConfigValidator, identity_path: Optional[str] = None):
        BloomPreTrainedModel.__init__(self, config)
...
class DistributedBloomForSequenceClassificationValidator(FromPretrainedMixinValidator, BloomForSequenceClassification):
    _keys_to_ignore_on_load_missing = DistributedBloomModelValidator._keys_to_ignore_on_load_missing
    _keys_to_ignore_on_load_unexpected = DistributedBloomModelValidator._keys_to_ignore_on_load_unexpected
