from subnet.substrate.chain_functions import propose
from subnet.substrate.tests.test_utils import MODEL_MEMORY_MB, MODEL_PATH, get_subnet_nodes_consensus_data, get_substrate_config
